	...
	const experiences: WorkExperience[] = [
		{
			...
			period: 'Internship',
			description: 'Web developer internship focused on PHP programming, CodeIgniter, Laravel, and WordPress development.',
			responsibilities: [
		...
		},
		{
			...
			description: 'Managed cross-functional development teams and coordinated project delivery across multiple stakeholders and departments.',
			responsibilities: [
			...
			technologies: ['Project Management', 'Team Leadership', 'Agile', 'Communication', 'Process Improvement'],
			image: image2
		},
		{
			id: '3',
			...
			description: 'Spearheaded the development and maintenance of the company\'s WordPress website, enhancing performance, scalability, and user experience through custom front-end framework integration.',
			responsibilities: [
			...
			technologies: ['WordPress', 'Custom Front-end Framework', 'SEO', 'Performance Optimization', 'Security'],
			image: image3
		},
		{
			id: '4',
			...
			description: 'Built tools and automation solutions using modern Web3 technologies, focusing on blockchain integration, DeFi protocols, and scalable developer tools.',
			responsibilities: [
		...
		},
		{
			...
			description: 'Developed and launched SaaS applications leveraging AI and Web3 technologies, focusing on productivity, automation, and robust system architecture.',
			responsibilities: [
...
<section id="work-history" class="bg-gradient-to-b from-gray-50 to-white py-16 sm:py-24">
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
		...
		<div class="mt-16 relative">
			{#if mounted}
				<!-- Vertical Line -->
				<div class="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-orange-500 via-orange-400 to-orange-300 md:left-1/2 md:-translate-x-1/2"></div>
				...
				<div class="space-y-12">
					{#each experiences as exp, index (exp.id)}
						...
						>
							<!-- Timeline Dot -->
							<div class="absolute left-8 flex h-6 w-6 items-center justify-center -translate-x-1/2 md:left-1/2">
								<div class="h-6 w-6 rounded-full border-4 border-white bg-orange-500 shadow-lg ring-4 ring-orange-100"></div>
							</div>

							<!-- Content - alternates left/right on desktop -->
							<div class="md:col-span-1 {index % 2 === 0 ? 'md:text-right md:pr-12' : 'md:col-start-2 md:pl-12'} ml-20 md:ml-0">
								<!-- Card -->
								<div class="group rounded-xl bg-white shadow-md transition-all hover:shadow-xl border border-gray-100 p-6">
									<!-- Image -->
									{#if exp.image}
									...
									<!-- Period Badge -->
										<div class="mb-3 inline-flex items-center gap-2 rounded-full bg-orange-50 px-3 py-1 text-md font-medium text-orange-700">
									...
									<!-- Description -->
									<p class="mt-3 text-gray-600 leading-relaxed text-left">
										{exp.description}
									</p>
									...
									<ul class="mt-4 space-y-2 text-left">
										{#each exp.responsibilities as responsibility}
											<li class="flex items-start gap-2 text-md text-gray-600">
